...
![](/assets/img/posts/language/java/jvm/jvm-structure.png)
...
![](/assets/img/posts/language/java/jvm/runtime-data-area.png)
...
- Heap은 크게 New/Young, Old 영역으로 나뉜다.
- 아래 그림에는 Permanent Generation이 함께 그려져 있는데, 이는 **Java 7까지의 구조**다. Perm은 원래 Heap이 아니라 Method Area의 구현체였고, Java 8에서 제거되며 Metaspace로 대체됐다(아래에서 이어 다룬다).

![](/assets/img/posts/language/java/jvm/heap-generation.png)
