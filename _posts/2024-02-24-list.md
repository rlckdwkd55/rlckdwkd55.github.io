...
tags: [collection, arraylist, linkedlist]
...
![](/assets/img/posts/language/java/list/data-structure.png)
...
![](/assets/img/posts/language/java/list/arraylist.png)
...
노드를 연결해 만든 리스트이며 List 인터페이스를 구현한 클래스 중 하나이다.
...
![](/assets/img/posts/language/java/list/linkedlist.png)
