...
![](/assets/img/posts/security/crypto/openssl/heartbleed-normal.png)
...
![](/assets/img/posts/security/crypto/openssl/heartbleed-attack.png)
...
![](/assets/img/posts/security/crypto/openssl/openssl-download-page.png)
...
![](/assets/img/posts/security/crypto/openssl/openssl-install-vcredist.png)

![](/assets/img/posts/security/crypto/openssl/openssl-install-wizard.png)
...
![](/assets/img/posts/security/crypto/openssl/openssl-env-conf.png)

#### Path

![](/assets/img/posts/security/crypto/openssl/openssl-env-path.png)
...
![](/assets/img/posts/security/crypto/openssl/openssl-version-check.png)
...
- `-extfile`로 **SAN**을 넣어 준 이유가 있다. Chrome 58부터 브라우저는 Common Name이 아니라 SAN을 보고 도메인을 검증하기 때문에, SAN이 없으면 앞서 말한 자체 서명 경고와는 별개로 인증서 자체가 거부된다.
