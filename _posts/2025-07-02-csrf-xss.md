...
![](/assets/img/posts/security/vulnerability/csrf-xss/csrf-flow.png)
...
1. **저장된 XSS (Stored XSS)**
   ![](/assets/img/posts/security/vulnerability/csrf-xss/stored-xss.png)
...
2. **반사된 XSS (Reflected XSS)**
   ![](/assets/img/posts/security/vulnerability/csrf-xss/reflected-xss.png)
...
3. **DOM 기반 XSS (DOM-based XSS)**
   ![](/assets/img/posts/security/vulnerability/csrf-xss/dom-xss.png)
...
![](/assets/img/posts/security/vulnerability/csrf-xss/spring-security-csrf.png)
